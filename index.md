...
{% include icon.html id="twitter" title="google-scholar" %}
{% include button.html icon="googlescholar" text="Google Scholar" link="https://scholar.google.com/citations?user=BlvnMOgAAAAJ&hl=en&oi=ao" color="#0d94e7" width=20%}
