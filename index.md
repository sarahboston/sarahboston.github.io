...
{% include icon.html id="academia" title="twitter" %}
{% include button.html icon="academia" text="Google Scholar" link="https://scholar.google.com/citations?user=BlvnMOgAAAAJ&hl=en&oi=ao" color="#0d94e7" width=20%}
